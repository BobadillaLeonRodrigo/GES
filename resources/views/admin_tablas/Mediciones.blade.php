...
<html lang="en">
    <head>
        ...
        <meta name="generator" content="Hugo 0.84.0">
            <title>Mediciones - Reportes</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <!-- Dependiendo de la tabla tendras su Grafica --><canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas>

            <h2>CRUD Mediciones</h2>
