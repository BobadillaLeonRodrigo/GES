...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 text-success text-center" href="index.html"><em><strong>TechPlant</strong></em></a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 bg-success rounded-3">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item text-center" href="{{route('cerrarsesion')}}"><em><strong>Cerrar Seción</strong></em></a></li>
                        <li><hr class="dropdown-divider border-success border border-3 rounded-2"/></li>
                    </ul>
                </li>
            </ul>
